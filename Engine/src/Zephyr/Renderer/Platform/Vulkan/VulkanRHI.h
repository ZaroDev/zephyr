...
namespace Zephyr
{
    ...
    public:
        ...
        virtual NODISCARD const char* GetName() const override { return "Vulkan"; }
        virtual NODISCARD RenderDevice GetRenderDevice() const override { return m_RenderDeviceInfo; }
        virtual void OnResize(u32 width, u32 height) override;
        virtual void BeginFrame() override;
        virtual void EndFrame() override;

        virtual void UploadModel(Ref<Model> model) override;
